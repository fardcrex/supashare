...
import 'package:supashare/components/auth_required_state.dart';
...
class _AccountPageState extends AuthRequiredState<AccountPage> {
  ...
  Future<void> _getProfile(String userId) async {
    ...
    final response = await supabase.from('profiles').select().eq('id', userId).single().execute();
  ...
  Future<void> _updateProfile() async {
    ...
    if (response.error != null) {
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text('Successfully updated profile!')));
    }
    setState(() {
      _loading = false;
    });
